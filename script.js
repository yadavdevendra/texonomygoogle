...
const div = document.querySelector("#animal");
function alltextdatainarray(array, parent) {
  const b = Object.keys(array);
  for (let i of b) {
    ...
    if (i) {
      ...
      alltextdatainarray(array[i], li);
      ol.addEventListener("click", (i) => toggleList(i, li));
      ol.append(li);
    }
    parent.append(ol);
  }

  function toggleList(i, li) {
    i.stopPropagation();
